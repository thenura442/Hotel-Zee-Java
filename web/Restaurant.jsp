        ...
        <div id="hero_restaurant" class="rev_slider gradient_slider" data-version="5.0.7">
            <ul>
                ...
                <li data-transition="fade">
                    <!-- MAIN IMAGE -->
                    <img src="images/restaurant/restaurant_hero.jpg" 
                         alt="Image" 
                    ...
                    <div class="tp-caption" 
                         ...
                         style="color: #fff; font-weight: 700; font-family: 'Raleway', sans-serif;">WELCOME TO HOTEL ZEE RESTAURANT
                    </div>
                </li>
            </ul>
        </div>
           ...
           <div class="container">
              <div class="row">
                 <div class="col-md-7">
                    ...
                    <p>Our Hotel Zee restaurant consists of local and international foods menu with affordable price rangers when compare to other hotels that are situated in Sri Lanka. This is the best place to enjoy your free time with your friends and family members. Our crew always follows international standards when treated to our valuable consumers. Our Ceylon Food Cabin is always open (24 Hours) for our guests. It provides Sri Lankan best luxurious food experience to you.</p>
                 </div>
                 <div class="col-md-5">
                    <div class="row">
                       <div class="col-md-6 col-sm-6 restaurant_img md_pr5">
                          <img src="images/restaurant/restaurant1.jpg" class="img-responsive full_width" alt="Image">
                       </div>
                       ...
                       <div class="col-md-6 col-sm-6 restaurant_img md_pr5">
                          <img src="images/restaurant/restaurant3.jpg" class="img-responsive full_width" alt="Image">
                       </div>
                       <div class="col-md-6 col-sm-6 restaurant_img md_pl5">
                          <img src="images/restaurant/restaurant4.jpg" class="img-responsive full_width" alt="Image">
                       </div>
                    </div>
                 </div>
              </div>
                    ...
                    <div class="menu_item">
                       <div class="row">
                          <div class="col-lg-4 col-md-6">
                             <figure>
                                <img src="images/restaurant/salat.jpg" class="img-responsive full_width" alt="Image">
                                </a>
                             </figure>
                          </div>
                          <div class="col-lg-8 col-md-6">
                             <div class="info">
                                <div class="title">
                                   <a  class="name">Salad</a>
                                   <span class="price">
                                   <span class="amount">Rs.2500</span>
                                   </span>
                                </div>
                                <p>You can taste our best and healthy salad menues in our hotel zee... </p>
                             </div>
                          </div>
                       </div>
                    </div>
                 ...
                 <div class="col-md-6 col-sm-6">
                    <div class="menu_item">
                       <div class="row">
                          <div class="col-lg-4 col-md-6">
                             <figure>
                                <img src="images/restaurant/croquettes.jpg" class="img-responsive full_width" alt="Image">
                                </a>
                             </figure>
                          </div>
                          <div class="col-lg-8 col-md-6">
                             <div class="info">
                                <div class="title">
                                   <a  class="name">Croquettes</a>
                                   <span class="price">
                                   <span class="amount">Rs.1500</span>
                                   </span>
                                </div>
                                <p>In our hotel you can taste best and hot Croquettes in lowest price ranger... </p>
                             </div>
                          </div>
                       </div>
                    </div>
                 ...
                 <div class="col-md-6 col-sm-6">
                    <div class="menu_item">
                       <div class="row">
                          <div class="col-lg-4 col-md-6">
                             <figure>
                                <img src="images/restaurant/pizza.jpg" class="img-responsive full_width" alt="Image">
                                </a>
                             </figure>
                          </div>
                          <div class="col-lg-8 col-md-6">
                             <div class="info">
                                <div class="title">
                                   <a class="name">Pizza</a>
                                   <span class="price">
                                   <span class="amount">Rs.2300</span>
                                   </span>
                                </div>
                                <p>In our property you can taste best and healthy italian pizzas... </p>
                             </div>
                          </div>
                       </div>
                    </div>
                 ...
                 <div class="col-md-6 col-sm-6">
                    <div class="menu_item">
                       <div class="row">
                          <div class="col-lg-4 col-md-6">
                             <figure>
                                <img src="images/restaurant/spaghetti.jpg" class="img-responsive full_width" alt="Image">
                                </a>
                             </figure>
                          </div>
                          <div class="col-lg-8 col-md-6">
                             <div class="info">
                                <div class="title">
                                   <a class="name">Spaghetti</a>
                                   <span class="price">
                                   <span class="amount">Rs.1350</span>
                                   </span>
                                </div>
                                <p>Best and healthy Spaghetti you can order now in our hotel restaurant... </p>
                             </div>
                          </div>
                       </div>
                    </div>
                 ...
                 <div class="col-md-6 col-sm-6">
                    <div class="menu_item">
                       <div class="row">
                          <div class="col-lg-4 col-md-6">
                             <figure>
                                <img src="images/restaurant/chicken.jpg" class="img-responsive full_width" alt="Image">
                                </a>
                             </figure>
                          </div>
                          <div class="col-lg-8 col-md-6">
                             <div class="info">
                                <div class="title">
                                   <a class="name">Roasted Chicken</a>
                                   <span class="price">
                                   <span class="amount">Rs.3500</span>
                                   </span>
                                </div>
                                <p>Best and hot roasted chicken now you can order from our restaurant... </p>
                             </div>
                          </div>
                       </div>
                    </div>
                       ...
                       <div class="row">
                          <div class="col-lg-4 col-md-6">
                             <figure>
                                ...
                                <img src="images/restaurant/cake.jpg" class="img-responsive full_width" alt="Image">
                                </a>
                             </figure>
                          </div>
                          <div class="col-lg-8 col-md-6">
                             <div class="info">
                                <div class="title">
                                   <a class="name">Lava cake</a>
                                   <span class="price">
                                   <span class="amount">Rs1350</span>
                                   </span>
                                </div>
                                <p>You can order now hot lava cake with under special discounts rates... </p>
                             </div>
                          </div>
                       </div>
                    </div>
              ...
              <p><b>Our crew always treat you the word best standard and healthy food and bevarages in affroadable price rangers...</b></p>
