<%-- 
    Document   : Registration-S
    Created on : Jan 13, 2022, 3:28:20 AM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zante - Registration Successful</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color:#00A8FF; ">You have Successfully Registered!!!</h1>
        <br><br><br>
        <h4 style="text-align: center;">Please Check if Registration Confirmation is Received via Email!!</h4>
        <br><br><br><br><br><br>
        <h4 style="text-align: center;"><a href="Sign-In.jsp"> Sign In</a></h4>
