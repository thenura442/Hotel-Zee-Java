<%-- 
    Document   : Contact-Ty
    Created on : Feb 2, 2022, 5:47:43 PM
...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Contact Us Successful</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h4 style="text-align: center;">Thank you for your Reply.<br><br>We will review the Message and get back to you within 24 hours.<br><br>Please Check if you Received a Confirmation Email</h4>
