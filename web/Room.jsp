                ...
                <nav id="main_menu" class="mobile_menu navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown simple_menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: orange;">Accommodation<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="" style="color: orange;">Rooms</a></li>
           ...
           <div class="container">
              ...
              <article class="room_list">
                 <div class="row row-flex">
                    <div class="col-lg-4 col-md-5 col-sm-12">
                       <figure>
                          <img src="images/accommodation/deluxeroom.jpg" class="img-responsive" alt="Image">
                       </figure>
                    </div>
                    <div class="col-lg-8 col-md-7 col-sm-12">
                       <div class="room_details row-flex">
                          <div class="col-md-9 col-sm-9 col-xs-12 room_desc">
                             <h3>Deluxe Room</h3>
                             <p>The deluxe rooms of our hotel give you the best luxurious comforts to you with many exclusive facilities and also rooms were designed with beautiful and colourful interior design structures. The Indian ocean and Colombo city beautiful views can be seen via the balcony of our deluxe rooms. These rooms are available with the most affordable price rangers when compare to the other luxurious hotel's rooms that are located in Colombo city.</p>
                             <br>
                             <h4>Available Facilities</h4>
                             <br>
                                <ul>
                                <li>Room Size - 46 SQM2</li>
                                <li>Broadband & Wi-fi</li>
                                <li>Air-condition</li>
                                <li>Celling Fan</li>
                                <li>Bathrobes</li>
              ...
              <article class="room_list">
                 <div class="row">
                    <div class="col-lg-4 col-md-5 col-sm-12">
                       <figure>
                          <img src="images/accommodation/premierroom.jpg" class="img-responsive" alt="Image">
                       </figure>
                    </div>
                    <div class="col-lg-8 col-md-7 col-sm-12">
                       <div class="room_details">
                          <div class="col-md-9 col-sm-9 col-xs-12 room_desc">
                             <h3>Premier Room</h3>
                             <p>The premier rooms on our property give you the best luxurious comforts to you with many exclusive facilities. These rooms are available with the most affordable price rangers when compare to the other luxurious hotel's rooms that are located in Colombo city. The Indian ocean and Colombo city beautiful views can be seen via the balcony of our premier rooms. This is the best place to enjoy vacations with your loved ones.</p>  
                             <br>
                             <h4>Available Facilities</h4>
                             <br>
                                <ul>
                                <li>Room Size - 52 SQM</li>
                                <li>Broadband & Wi-fi</li>
                                <li>Air-condition</li>
                                <li>Celling Fan</li>
                                <li>Safety Locker</li>
              ...
              <article class="room_list">
                 <div class="row">
                    <div class="col-lg-4 col-md-5 col-sm-12">
                       <figure>
                          <img src="images/accommodation/studioroom.jpg" class="img-responsive" alt="Image">
                       </figure>
                    </div>
                    <div class="col-lg-8 col-md-7 col-sm-12">
                       <div class="room_details">
                          <div class="col-md-9 col-sm-9 col-xs-12 room_desc">
                             <h3>Studio Room</h3>
                             <p>Our studio rooms were designed with the most attractive interior design architectures and also rooms were coming with many exclusive facilities. The Indian ocean and Colombo city beautiful views can be seen via the balcony of our studio rooms. These rooms are available at the most affordable price packages.</p> 
                             <br>
                             <h4>Available Facilities</h4>
                             <br>
                                <ul>
                                <li>Room Size - 92 SQM</li>
                                <li>Broadband & Wi-fi</li>
                                <li>Air-condition</li>
                                <li>Celling Fan</li>
                                <li>Bathrobes</li>
              ...
              <div style="text-align: center;">
                  <a href="Booking.jsp" style="color: white"><button class="btn btn-info btn-md" style="font-size: 20px; padding: 20px; width: 20%;"> Make A Reservation</button></a>
              </div>
          </Main>
