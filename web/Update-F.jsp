<%-- 
    Document   : Update-F
    Created on : Feb 2, 2022, 2:42:37 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Update Failed</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color:#00A8FF;">Update Failed!!</h1>
        <br><br><br><br><br>
        <h4 style="text-align: center;">Password Updating has failed!!<br>Please Try Again Later.</h4>
