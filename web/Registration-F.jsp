<%-- 
    Document   : Registration-F
    Created on : Jan 13, 2022, 3:31:52 AM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zante - Registration Failed</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #00A8FF;">Registration Failed!! </h1>
        <br><br><br><br><br>
        <h4 style="text-align: center;">Registration Unsuccessful <br> <br> Please Try Again Later!!!</h4>
