<%-- 
    Document   : Signed-In
    Created on : Feb 5, 2022, 12:12:53 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Already Signed-In</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #00A8FF;">Already Signed In!! </h1>
        <br><br><br><br><br><br>
        <h4 style="text-align: center;">You Have Already Signed In to Your Account.<br><br>Please Log Out First!!</h4>
