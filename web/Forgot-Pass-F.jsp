<%-- 
    Document   : Forgot-Pass-F
    Created on : Feb 5, 2022, 5:47:51 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Forgot-Password Server Fail</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <br><br><br><br><br>
        <h1 style="text-align: center; color: #00A8FF;">Server Failure! </h1>
        <br><br><br><br><br><br>
        <h4 style="text-align: center;">Cannot Access Server at the Moment!!!<br><br>Please Try Again later in a Few Minutes.</h4>
