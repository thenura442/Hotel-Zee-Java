<%-- 
    Document   : Deletion-F
    Created on : Feb 2, 2022, 2:46:18 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Account Deletion Failed</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #00A8FF;">Account Deletion Failed!!</h1>
        <br><br><br><br>
        
        <h4 style="text-align: center;">Account Deletion has Failed!!<br>Please Try Again Later.</h4>
