<%-- 
    Document   : Forgot-Pass-Wrong
    Created on : Feb 5, 2022, 5:50:23 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Wrong Email</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #2596be;">Forgot Password</h1>
        <br><br><br>
            ...
            <div class="container-sign">
                    <div class="inner-sign">
                        <form action="forgotpass" method="post">
                            <h3 class="text-center text-info">Enter Your Account Email</h3><br><br>
                                <div>
                                    <label for="email" class="text-info">Email:</label><br>
                                    <input type="email" name="email" id="email" class="form-control" required placeholder="Account Email">
                                </div>
                                <br>
        ...
        <br><br><br>
        <h4 style="text-align: center; color: red;">The Entered Email does not have an Account affiliated with It!!!</h4>
