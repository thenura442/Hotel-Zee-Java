<%-- 
    Document   : Login-First
    Created on : Feb 5, 2022, 12:18:31 PM
...
<%-- 
    Document   : Sign-In
    Created on : Jan 26, 2022, 3:58:10 PM
    Author     : adala_06k8xra
--%>
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Login First</title>
...
<body>
    <% 
           ...
           {
               response.sendRedirect("Signed-In.jsp");
           }
           else
           {
        %>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <br><br><br><br><br><br>
        <h1 style="text-align: center; color: #2596be;">Sign In Form</h1>
        <br><br><br>
                    ...
                    <div class="inner-sign">
                        <form action="signin" method="post">
                                ...
                                <br>
                                    ...
                                    <a href="Forgot-Pass.jsp" class="text-info">Forgot Password</a>
                                    </div>
                                    <div> 
        ...
        <br><br><br><br><br>
        <h4 style="text-align: center; color: red;">Please Sign In First!!</h4>
