<%-- 
    Document   : Pass-match
    Created on : Feb 2, 2022, 2:19:32 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Change Password Match Password</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
                    ...
                    <div class="inner-sign">
                        <form action="passupdate" method="post">
                                <div>
                                    ...
                                    <input type="Password" name="password" required id="password" class="form-control" placeholder="********" required><br>
                                </div>
                                <div>
        ...
        <br><br><br>
        <h4 style="text-align: center; color: red;">Please Enter Matching New Passwords!!!</h4>
