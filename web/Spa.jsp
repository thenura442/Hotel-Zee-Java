...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zante - Our Spa</title>
            ...
            <div class="container">
                ...
                <nav id="main_menu" class="mobile_menu navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown simple_menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: orange;">Wellness <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="" style="color: orange;">Our Spa</a></li>
        ...
        <div id="hero_spa" class="rev_slider gradient_slider" data-version="5.0.7">
            <ul>
                ...
                <li data-transition="fade">
                    <!-- MAIN IMAGE -->
                    <img src="images/spa/spa_hero.jpg" 
                         alt="Image" 
                    ...
                    <div class="tp-caption" 
                         ...
                         style="color: #fff; font-weight: 700; font-family: 'Raleway', sans-serif;">WELCOME TO YOUR RELAXATION PARADISE
                    </div>
                </li>
            </ul>
        </div>
            ...
            <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <p>Experience total revitalization at Iridium Spa. Occupying its own island in the middle of a private lagoon at The St. Regis Bora Bora Resort, this unique 13,000-square-foot spa is a haven of sun-dappled serenity, where peace and rejuvenation go hand-in-hand. Its secluded beach, facing the majestic Mount Otemanu, is the perfect place to spend a day in calm contemplation.</p>
                        </div>
                        <div class="col-md-5">
                            <img src="images/spa/spa_big.jpg" class="img-responsive full_width" alt="Image">
                        </div>
                    </div>
                    ...
                    <div class="row image-gallery">
                        <div class="col-md-3 col-sm-6 mt20 mb20">
                            <a href="images/spa/spa1.jpg" class="hover_effect h_lightbox h_blue">
                                <img src="images/spa/spa1.jpg" class="img-responsive full_width br2" alt="Image">
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6 mt20 mb20">
                            <a href="images/spa/spa2.jpg" class="hover_effect h_lightbox h_blue">
                                <img src="images/spa/spa2.jpg" class="img-responsive full_width br2" alt="Image">
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6 mt20 mb20">
                            <a href="images/spa/spa3.jpg" class="hover_effect h_lightbox h_blue">
                                <img src="images/spa/spa3.jpg" class="img-responsive full_width br2" alt="Image">
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6 mt20 mb20">
                            <a href="images/spa/spa4.jpg" class="hover_effect h_lightbox h_blue">
                                <img src="images/spa/spa4.jpg" class="img-responsive full_width br2" alt="Image">
                            </a>
                        </div>
                    </div>
                
                    <p>Enjoy a selection of Polynesian and Asian Touch treatments in one of our five treatment rooms, and relax in our Relaxation Room which offers views of our gorgeous private lagoonarium. We offer an enhanced spa experience at The St. Regis Bora Bora Resort, using therapeutic treatment methods and products created from sophisticated plant science.</p>
            </div>
        </main>
