<%-- 
    Document   : Reservation-F
    Created on : Feb 3, 2022, 5:32:34 PM
...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Reservation Failed</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 class="text-center text-info" style="color: #00A8FF;">Oops!!</h1>
        <br><br><br><br>
