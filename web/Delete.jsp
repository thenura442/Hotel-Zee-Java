<%-- 
    Document   : Delete
    Created on : Feb 1, 2022, 2:47:28 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Delete Account</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #2596be;">Account Deletion</h1>
        <br><br>

        <!-- ========== Delete Account ========== -->
        
        <p style="text-align: center;">Please Enter your password to verify your identity</p>
                    ...
                    <div class="inner-sign">
                        <form action="delete" method="post">
                            ...
                            <div style="text-align: center;"> 
                                    <input type="submit" name="dlt" class="btn btn-info btn-md" value="Delete Account">
                                    </div>
                        </form>
                    </div>    
            </div>
        ...
        <div style="text-align: center;">
            <br><br>
            <a href="display">Back to Profile</a>
        </div>
