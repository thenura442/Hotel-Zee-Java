...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Account Deleted</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
            ...
            <div class="container">
                <div class="inner"> 
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Profile-Signed.jsp">Profile</a></li>
        ...
        <h1 style="text-align: center; color: #00A8FF;">Your Account has Successfully been Deleted. </h1>
        <br><br><br>
        
        
        <h4 style="text-align: center;">Dear Customer Thank You for joining us and any complaint <br>or issue regarding account deletion<br> can be submitted to us through any form of contact you wish.<br><br><br> Hope to see you with us again!!</h4>
        
        <br><br>    
        <div style="margin-left: 46%; margin-right: 46%;">
            <a href="Contact.jsp" style="color:white; padding: 10px;"><button class="btn btn-info btn-md">Issue a Complaint</button></a>
        </div>
