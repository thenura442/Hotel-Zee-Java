<%-- 
    Document   : Password-Updated
    Created on : Feb 2, 2022, 3:15:38 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Password Updated</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #00A8FF;">Update Successful!!</h1>
        <br><br><br><br><br>
        <h4 style="text-align: center;">Password Updated Successfully!!</h4>
