<%-- 
    Document   : Forgot-Pass-S
    Created on : Feb 5, 2022, 5:40:44 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Forgot-Password Email Sent</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color:#00A8FF;">Email Sent!!</h1>
        <br><br><br><br><br>
        <h4 style="text-align: center;">A Password Reset Link has been Sent to the Entered Email!!!<br><br>Check Your Email.</h4>
