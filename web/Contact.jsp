...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Contact Us</title>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <div class="p-text">
            <p style="font-size: 16px">
                For any Information Required or other complaints please contact us through the provided form below.<br> We will get back to you within 24 hours through the email or Contact that have been provided to us.
            </p>
        </div>
        ...
        <div class="container-sign" style="margin-left: auto; margin-right: auto; width: 50%;">
            <form action="contact" method="post" style="margin-left: auto; margin-right: auto; width: 50%;">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" class="form-control" placeholder="Your Email" required style="border: 1px solid lightblue;">
                                </div>
                                <br>
                                <div>
                                    <label for="fname" class="text-info">First Name:</label><label style="color: red; font-size: 20px;">*</label> <br>
                                    <input type="text" name="fname" id="fname" class="form-control" placeholder="Your First Name" required style="border: 1px solid lightblue;">
                                </div>
                                <br>
                                <div>
                                    <label for="lname" class="text-info">Last Name:</label><label style="color: red; font-size: 20px;">*</label> <br>
                                    <input type="text" name="lname" id="lname" class="form-control" placeholder="Your Last Name" required style="border: 1px solid lightblue;">
                                </div>
                                <br>
                                <div>
                                    <label for="phone" class="text-info">Contact No:</label><label style="color: red; font-size: 20px;">*</label> <br>
                                    <input type="tel" name="phone" id="phone" class="form-control" placeholder="Your Phone Number" required style="border: 1px solid lightblue;">
                                </div>
                                <br>
                                <div>
                                    <label for="subject" class="text-info">Subject:</label><label style="color: red; font-size: 20px;">*</label><br>
                                    <input type="text" name="subject" id="subject" class="form-control" placeholder="Subject.." required style="border: 1px solid lightblue;">
                                </div>
                                <br>
                                <div>
                                    <label for="message" class="text-info">Your Comments</label><label style="color: red; font-size: 20px;">*</label> 
                                    <textarea class="form-control" name="message" placeholder="Your Issue or Comment.." required red style="border: 1px solid lightblue;"></textarea>
                                    </div>
                                <br>
                                    <div> 
