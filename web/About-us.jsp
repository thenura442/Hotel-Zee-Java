<%-- 
    Document   : About-us
    Created on : Feb 4, 2022, 3:48:57 PM
...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - About Us</title>
    ...
    <div id="loading">
        ...
        <main id="about_us_page">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1 class="mb30">Hotel Zee - Since 2002</h1>
                        <p>Hotel zee has been operating for more than 20 years to this day, It has been getting alot of attention lately with increasing tourism to the country, Our hotel is one of the well known hotel franchises in the country, At Hotel Zee we strive to be the first choice in the mind of guests, owners and talent. In our journey to achieve this, we practice strong beliefs and actions that respect the diversity of people, the community, ethics and the planet.</p>

                        <p>Our team is committed to extra thoughtful care and are passionate with delivering an amazing hotel experience. Hotel Zee is located in Colombo 1 hunupitiya besides the wellknown landmark Gangarama Temple, The hotel offers 3 modern Classic rooms (single or double) and 5 suites, including rooms which are spacious and air-conditione, each of them provides wireless Internet access, mini bar, coffee making facility, satellite LCD television, bathrobes and a hairdryer. During their stay, hotel guests can enjoy the Wellness zone of the SPA Center comprising a swimming pool, sauna, jacuzzi and a large gym. </p>
                    </div>
                    <div class="col-md-5">
                        <div class="about_img">
                ...
                <div class="row image-gallery">
                    <div class="col-md-3 col-sm-6 mt20 mb20 br2">
                            <img src="images/About us/1.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6 mt20 mb20 br2">
                            <img src="images/About us/2.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6 mt20 mb20 br2">
                            <img src="images/About us/3.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6 mt20 mb20 br2">
                            <img src="images/About us/4.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                </div>
                <p>Hotel Zee is a perfect venue for a comfortable stay as well as business meetings, conferences and trainings. Unique atmosphere of the hotel is ensured by: an aquarium with freshwater fish and a capacity of 9000 liters and 90" TVs installed in the Winter Garden and the Lounge Bar where you can enjoy a cup of aromatic coffee. Finezja Restaurant offers dishes of both Polish and international cuisine, providing guests with a variety of tastes owing to carefully selected recipes.

                Additionally, Hotel Zee has a range of conference and banquet facilities. We offer 3 multifunctional rooms with modern conference equipment. Rooms with a total area of over 240 square meters are located on the ground floor and give room for flexible arrangement solutions. Our guests are also provided with free-of-charge access to Spa & Wellness Center with an indoor swimming pool and a well-equipped gym.

               <h3><b>Mission</b></h3><br>
               The mission of the Hotel Zee is to put hospitality services on the highest level in order to satisfy the demands and expectations of guests. Our aim is to make the Hotel Zee a place for encounters, business success, pleasant meetings and ceremonies.   </p>
