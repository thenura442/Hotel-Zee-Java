<%-- 
    Document   : Reservation-S
    Created on : Feb 3, 2022, 5:40:01 PM
...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Registration Successful</title>
...
<body>
    ...
    <!-- ========== HEADER ========== -->
        ...
        <h1 class="text-center text-info" style="color: #00A8FF;">Reservation Successful!!</h1>
        <br><br><br><br>
        <h4 style="text-align: center;">Thank You For the Reservation.<br><br>Please Check if Confirmation Messages on Email and Phone has been Received.<br><br>If Confirmation is not received within 5 Minutes Try Contacting Us.</h4>
        
        <br><br><br><br><br>
        <div style="text-align: center;">
            <br><br>
            Still didnt get a Confirmation? Issue a Complaint
            <a href="Contact.jsp">Here</a>
        </div>
