<%-- 
    Document   : Reset-Pass-F
    Created on : Feb 5, 2022, 6:09:53 PM
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zee - Password Reset Failed</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h1 style="text-align: center; color: #00A8FF;">Update Unsuccessful!!</h1>
        <br><br><br><br><br>
        <h4 style="text-align: center;">Password Updating Failed!!<br> Please Try Again Later or Issue a Complaint!</h4>
        <br><br><br>    
