<%-- 
    Document   : Profile-Signed
    Created on : Jan 30, 2022, 10:21:38 AM
    Author     : adala_06k8xra
--%>

<%@page import="daoPackage.displaydao"%>
...
<head>     
    ...
    <!-- ========== SEO ========== -->
    <title>Hotel Zante - Profile</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <h3 class="text-center text-info" style="color: #2596be;">Account Details</h3>
        
        <br><br><br><br>
        <div style="margin-left: auto; margin-right: auto; text-align: center; border: 1px solid #00A8FF; max-width: 30%; padding: 20px; border-radius: 50px;">
        <table style="margin-left: 13%; margin-right: auto; text-align: center;">
        <%
            String member = (String)session.getAttribute("email");
            
            List<user> list = displaydao.display(member);
            for(user u:list)
            {
            
        %>
           <tr><th style="padding: 50px; font-weight: bold;" class="text-info">Email :</th>
               <td style="padding: 50px; color: black; float: left;"><%=u.getemail()%></td>
           </tr>
            <tr>
                <th style="padding: 50px; font-weight: bold;" class="text-info">First Name :</th>
                <td style="padding: 50px; color: black; float: left;"><%=u.getfname()%></td>
            </tr>
            <tr>
                <th style="padding: 50px; font-weight: bold;" class="text-info">Last Name :</th>
                <td style="padding: 50px; color: black; float: left;"><%=u.getlname()%></td>
            </tr>
            <tr>
                <th style="padding: 50px; font-weight: bold;" class="text-info">Contact :</th>
                <td style="padding: 50px; color: black; float: left;"><%=u.getphone()%></td>
            </tr>
        ...
        <div style="text-align: center;"> 
            <a href="Password_Change.jsp">Change Password</a>
            <br><br>
